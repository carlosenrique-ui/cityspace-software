...
def build_zigzag_path():
    ...
    for c in range(0, GRID_COLS):  # esquerda -> direita
        if c % 2 == 0:
            rows = range(0, GRID_ROWS)  # topo -> base
        else:
            rows = range(GRID_ROWS - 1, -1, -1)  # base -> topo
...
def make_fig(layers, step, cell_mode, projector_mode):
    ...
    fig.update_layout(
        margin=dict(l=30, r=90, t=30, b=30),
...
if __name__ == "__main__":
    print("========================================")
    print("V128.7 — UI OPERACIONAL SEM REGRESSÃO")
    print("========================================")
    print("CSV:", CSV_PATH)
    print("PNG:", PNG_PATH)
