...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Div(id="menu-body", children=[
            ...
            html.Hr(),
            dcc.Store(id="projector-mode", data="normal"),
            dcc.RadioItems(
                id="projector-mode-duplicate-disabled-1",
                options=[
...
@app.callback(
    Output("cityspace-v128716", "figure"),
...
if __name__ == "__main__":
    print("========================================")
    print("V128.7.16 — NORTH LEFT FINAL")
    print("========================================")
    print("CSV:", CSV_PATH)
    print("PNG:", PNG_PATH)
