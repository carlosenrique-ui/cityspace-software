...
OUTPUT_PNG = ONLINE_ASSETS_DIR / "ipt_mask_rotated_grid_aligned.png"
...
def render_png(gdf: gpd.GeoDataFrame, output_png: Path) -> None:
    ...
    gdf.plot(
        ax=ax,
        color=(0.15, 0.15, 0.15, 0.22),
        edgecolor=(0.05, 0.05, 0.05, 0.45),
        linewidth=0.8,
    )
...
def main() -> None:
    print_header("IPT-CITYSPACE | GRID-ALIGNED WATERMARK")
