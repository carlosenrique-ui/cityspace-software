...
# ajuste fino APENAS do watermark
SCALE_X = 0.85
SCALE_Y = 0.75
OFFSET_X = -0.08
OFFSET_Y = 0.08
...
# carrega PNG e remove branco externo/"papel" muito claro
...
white_mask = (rgb[:, :, 0] > 245) & (rgb[:, :, 1] > 245) & (rgb[:, :, 2] > 245)
alpha[white_mask] = 0
...
app.layout = html.Div([
    dcc.Graph(id="graph", config={"displayModeBar": False}, style={"width": "100%", "height": "85vh"}),
    html.Div([
        html.Button("<<", id="back"),
...
if __name__ == "__main__":
    print(">>> DASH V96 PNG V3 ALPHA STABLE <<<", flush=True)
