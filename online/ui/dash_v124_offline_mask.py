...
CSV_PATH = CORE_ROOT / "offline/products/scientific/grid_metrics_utm_masked.csv"
...
# =========================================
# V124 — MÁSCARA DO OFFLINE (FONTE DA VERDADE)
# =========================================

offline_mask = df["is_inside_polygon"].values.reshape(GRID_ROWS, GRID_COLS)

offline_mask = fix_like_v42(offline_mask).astype(bool)

valid_mask = height_mask & offline_mask
...
if __name__ == "__main__":
    print("========================================")
    print("V124 — OFFLINE MASK + LAYERS + COTAS")
    print("========================================")
    print("CSV:", CSV_PATH)
    print("PNG:", PNG_PATH)
    ...
    print("Valid cells OFFLINE mask:", int(valid_mask.sum()))
    print("========================================")
    app.run(debug=True)
