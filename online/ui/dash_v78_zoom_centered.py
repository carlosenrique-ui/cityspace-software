...
for i in range(1,len(path)):
 ...
 dt=0.2*d + 0.08*h   # mais lento (mesa real)
...
def render(time,zoom):
 ...
 fig.update_xaxes(range=[x0,x1],scaleanchor="y",scaleratio=1)
