...
# ============================================================
# IPT-CITYSPACE | DASH V96 | WATERMARK OK
# Baseline preservado do V96
# - mesma lógica de player
# - mesma timeline
# - mesma célula ativa
# - usando novo watermark alinhado ao grid
# ============================================================
...
print("==================================================", flush=True)
print(">>> IPT-CITYSPACE | V96 WATERMARK OK <<<", flush=True)
print("==================================================", flush=True)
...
def rd(t):
    ...
    fig.update_layout(
        images=[
            dict(
                source="/assets/ipt_mask_rotated_grid_aligned.png",
                xref="x",
                yref="y",
                x=-0.5,
                y=ny - 0.5,
...
if __name__ == "__main__":
    print(">>> RUNNING V96 WATERMARK OK <<<", flush=True)
