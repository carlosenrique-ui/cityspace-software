        ...
        html.Div(id="menu-body", children=[
            ...
            dcc.Checklist(
                ...
                options=[
                    ...
                    {"label": "Contour edifícios z_building_m", "value": "contour_building"},
                    {"label": "Cotas edifícios", "value": "cota_building"},
                    {"label": "Contour teto z_total_m", "value": "contour_total"},
                    {"label": "Cotas teto", "value": "cota_total"},
                    {"label": "Grid 16x8", "value": "grid"},
                ],
                value=["base", "terrain", "building", "total", "contour_terrain", "cota_terrain", "contour_total", "cota_total", "grid"],
            ),
...
if __name__ == "__main__":
    print("========================================")
    print("V128.7.23 — IPT VIRTUAL CLEAN SCREEN")
    print("========================================")
    print("CSV:", CSV_PATH)
    print("PNG:", PNG_PATH)
