...
# ============================================================
# LOAD + TRANSFORM WATERMARK
# ============================================================
img = Image.open(WATERMARK).convert("RGBA")
img = img.transpose(Image.Transpose.FLIP_TOP_BOTTOM)

# Rotação pequena no próprio PNG antes de ir para o Plotly
img = img.rotate(
    ROTATE_DEG,
...
if __name__ == "__main__":
    print(">>> RUNNING WATERMARK TRANSFORM TEST <<<", flush=True)
