...
X = (1.0 - SCALE) / 2.0 + OFFSET_X
Y = 1.0 - (1.0 - SCALE) / 2.0 + OFFSET_Y
...
@app.callback(Output("direction","data"),
              Input("fwd","n_clicks"),
              Input("back","n_clicks"),
...
@app.callback(Output("time","data"),
              ...
              State("time","data"))
def cb_time(n,r,d,t):
    return t if not r else max(0.0, min(TMAX, t + d*0.05))
...
def render_graph(t):
    ...
    # =========================================
    # HEATMAP PRESERVADO (NÃO ALTERAR)
    # =========================================
...
if __name__ == "__main__":
    print(">>> TEST SCALE 0.68 <<<", flush=True)
    print("SCALE:", SCALE)
