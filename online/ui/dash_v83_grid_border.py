...
def render(time,zoom):
 ...
 fig=go.Figure()
 fig.add_trace(go.Heatmap(z=z,colorscale="Viridis",zmin=0,zmax=10,xgap=2,ygap=2,colorbar=dict(title="Altura (cm / m)")))
 fig.update_layout(width=base_w*scale,height=base_h*scale,margin=dict(l=0,r=0,t=0,b=0),plot_bgcolor="white")
