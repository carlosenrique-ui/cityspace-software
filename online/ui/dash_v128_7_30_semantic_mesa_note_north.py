...
import dash
from dash import dcc, html, Input, Output, State, State, ctx
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Div(id="menu-body", children=[
            ...
            html.Div(
                "A mesa representa a altura total do pino em centímetros e o valor equivalente do teto em metros, referenciado à cota zero local.",
                style={"fontSize": "11px", "color": "#555", "marginTop": "4px", "lineHeight": "1.25"}
            ),
...
def update_ui(analysis_domain, view_options, structure_options, table_options, step, cell_mode, mesa_real):
    ...
    if mesa_pinos_on:
        layers.append("pinos")
        effective_domain = "total"  # Mesa/Pinos força Z total
    else:
...
if __name__ == "__main__":
    print("========================================")
    print("V128.7.30 — IPT SEMANTIC MESA NOTE NORTH")
    print("========================================")
    print("CSV:", CSV_PATH)
    print("PNG:", PNG_PATH)
