...
# Flechas brancas:
# - subir ponta esquerda
# - rodar para a direita descer
...
# ============================================================
# WATERMARK: flip + padding + rotate around center
# ============================================================
...
canvas = Image.new("RGBA", (w + 2 * pad_x, h + 2 * pad_y), (255, 255, 255, 0))
...
canvas = canvas.rotate(
    ...
    expand=False,
    center=(canvas.size[0] / 2, canvas.size[1] / 2),
...
if __name__ == "__main__":
    print(">>> DASH V96 WATERMARK CENTROID FIT <<<", flush=True)
