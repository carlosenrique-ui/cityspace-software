...
def make_fig(layers, step, cell_mode):
    fig = go.Figure()
    ...
    fig.update_layout(
        ...
        paper_bgcolor="white",
        autosize=True,
        uirevision="v128_8_sem_projetor",
    )
...
def update_ui(layers, step, cell_mode, mesa_real):
    ...
    fig = make_fig(layers or [], step, cell_mode)
...
if __name__ == "__main__":
    print("========================================")
    print("V128.8 — UI FINAL SEM PROJETOR")
    print("========================================")
    print("CSV:", CSV_PATH)
    print("PNG:", PNG_PATH)
