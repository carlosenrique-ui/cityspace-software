        ...
        html.Div(id="menu-body", children=[
            ...
            dcc.Checklist(
                ...
                options=[
                    ...
                    {"label": "──────── MODELO PRINCIPAL ────────", "value": "_sep1"},

                    {"label": "Terreno z_terrain_m", "value": "terrain"},
                    {"label": "Edifícios z_building_m", "value": "building"},
                    {"label": "Z total = terreno + edifício", "value": "total"},

                    {"label": "──────── CONTORNOS ────────", "value": "_sep2"},

                    {"label": "Contorno terreno", "value": "contour_terrain"},
                    {"label": "Contorno edifício", "value": "contour_building"},
                    {"label": "Contorno total", "value": "contour_total"},

                    {"label": "──────── COTAS ────────", "value": "_sep3"},

                    {"label": "Cotas terreno", "value": "cota_terrain"},
                    {"label": "Cotas edifício", "value": "cota_building"},
                    {"label": "Cotas total", "value": "cota_total"},

                    {"label": "──────── ESTRUTURA ────────", "value": "_sep4"},

                    {"label": "Grid 16x8", "value": "grid"},

                    {"label": "──────── MESA ────────", "value": "_sep5"},

                    {"label": "Pinos / Teto z_total", "value": "pinos"},
                ],
                value=["terrain", "building", "total", "pinos", "contour_total", "cota_total", "grid"],
            ),
...
if __name__ == "__main__":
    print("========================================")
    print("V128.7.24 — IPT VIRTUAL CLEAN")
    print("========================================")
    print("CSV:", CSV_PATH)
    print("PNG:", PNG_PATH)
