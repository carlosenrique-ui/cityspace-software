...
# =========================================
# LOAD GRID REAL (PIPELINE OFFLINE)
# =========================================
...
print(">>> SCALE (m/cm):", scale_m_per_cm, flush=True)
...
def render(t):
 ...
 # 🔥 GRID + REMOÇÃO FORA DO URBANISMO
 Z=grid.copy()
 Z[Z==0]=np.nan

 fig=go.Figure()

 # 🔥 IPT BASE (PROTAGONISTA)
...
if __name__=="__main__":
 print(">>> V95.2 FINAL OK <<<",flush=True)
