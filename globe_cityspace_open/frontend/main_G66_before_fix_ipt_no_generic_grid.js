...
function openCity() {
  ...
  if (activeCityKey === "ipt") {
    ...
    drawGrid(city.west, city.south, city.east, city.north);

    document.getElementById("areaInfo").innerHTML = `
      <b>IPT Demo North-Up</b><br>
      Envelope real da extração IPT carregado.<br>
      Grid real: ${TABLE_COLS} × ${TABLE_ROWS} = ${TABLE_COLS * TABLE_ROWS} células/pinos.<br>
      Referencial: Norte para cima, rotação 0°.<br>
      Tela 2 / Mesa Virtual:<br>
