...
function openCity() {
  ...
  if (activeCityKey === "ipt") {
    ...
    document.getElementById("areaInfo").innerHTML = `
      ...
      Envelope real da extração IPT carregado.<br>
      Nesta tela mostramos o recorte geográfico real da demonstração.<br>
      O grid físico real 16×8 pertence à Tela 2 / Mesa Virtual.<br>
      Referencial: Norte para cima, rotação 0°.<br><br>
      <b>Representação selecionada:</b><br>
      ${getIptCellMode()}<br><br>
      1:8867 → 1×1 cm<br>
      1:4433 → 2×2 cm<br>
      Relação entre escalas: 2 ou 1/2 conforme o tamanho da célula.<br><br>
      Use <b>Projection Mapping</b> para abrir a demonstração IPT-CitySpace corrigida.
    `;
