...
function computeIptRealDimensions() {
  ...
  // Extensão real do levantamento DTM/DSM local:
  // bounds nativos: x 4599.52–5624.48, y 1191.15–1900.47
  // largura ≈ 1025 m, altura ≈ 709 m.
  // As escalas abaixo são as representações físicas da mesa,
  // não redefinem o envelope geográfico do levantamento.
  const surveyWidthM = 1024.9607;
  const surveyHeightM = 709.3251;
...
function createIptDemoGrid() {
  ...
  document.getElementById("areaInfo").innerHTML = `
    ...
    Área real: ${dims.widthM.toFixed(1)} m × ${dims.heightM.toFixed(1)} m<br>
    Células/pinos: 16 × 8 = 128<br>
    Referencial: Norte para cima, rotação 0°.<br><br>
